...
def calcular_puntaje(respuestas, cols, efectos, res=False):
    ...
    for i, c in enumerate(cols):
        if type(respuestas[c]) != str: mult = 0.0
        else: mult = resp[ respuestas[c] ]
    ...
    return (igualdad, nacion, libertad, tradicion)