...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--escala', type=bool, default=False)      #"cambiar escala"  = normalizar con min max
    ...
    promedios_totales.append(generos)
    FuncionObjetivo(alpha, ejes_alpha, beta, ejes_beta, gamma, ejes_gamma, x, N, M, L, promedios_totales )
    """
